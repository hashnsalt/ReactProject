          ...
          <Col>
            {
              data.map((item, i) => {
                return (
                  <>
                    {item.tag01 === '캐주얼' || item.tag02 === '캐주얼' || item.tag03 === '캐주얼' || item.tag04 === '캐주얼' || item.tag05 === '캐주얼' ?
                      <Row>
                          ...
                          <div className="item_info">
                            ...
                            <div class='price'>
                              ...
                              <button className='cart_add_btn' onClick={() => {
                                dispatch(addItem({ id: item.id, image: <img src={item.image} alt='' />, name: item.name, num: item.num, price: item.price, discount: item.discount, count: 1 }))
                                setAlert(true);
                              }}>장바구니</button>
                            </div>
                          </div>
